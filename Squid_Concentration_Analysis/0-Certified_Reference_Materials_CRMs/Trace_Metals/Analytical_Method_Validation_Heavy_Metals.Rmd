...
certified_values <- data.frame(
  Element = c("Metal_A", "Metal_B", "Metal_C", "Metal_D", "Metal_E", "Metal_F", "Metal_G", "Metal_H", "Metal_I"),
...
mean_SD_data <- data.frame(
  Trace_Metals_mgkg = c("Metal_A", "Metal_B", "Metal_C", "Metal_D", "Metal_E", "Metal_F", "Metal_G", "Metal_H", "Metal_I"),
...
recovery_data <- data.frame(
  Trace_Metals = c("Metal_A", "Metal_B", "Metal_C", "Metal_D", "Metal_E", "Metal_F", "Metal_G", "Metal_H", "Metal_I"),
...
long_data$Element <- factor(long_data$Element, levels = c("Metal_A", "Metal_B", "Metal_C", "Metal_D", "Metal_E", "Metal_F", "Metal_G", "Metal_H", "Metal_I"))
...
-Some elements (Metal_H and Metal_I) showed high recoveries, indicating potential overestimation possibly due to matrix effects or contamination.

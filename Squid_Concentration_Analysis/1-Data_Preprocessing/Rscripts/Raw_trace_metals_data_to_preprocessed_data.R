...
trace_metal_batch<- read.csv("Datasets/Trace_Metals_Raw_Data/TM_2020_MLBatch.csv", header= FALSE)
dry_weight <- read.csv("Datasets/Trace_Metals_Raw_Data/Dry_weight_data /2020dryweight_TM.csv", header=TRUE)# Has to be changed based on the year
squid_info <- read.csv("Datasets/Squid_Catch_Data/2020_catch_data.csv", header= TRUE) # Has to be changed based on the year
distance_to_land <- read.csv("Datasets/Squid_Catch_Data/Distance_to_land.csv", header= TRUE) # Has to be changed based on the year
...
Final_res = "Datasets/Cleaned_data/Final_TMresults_mgkg.csv"
